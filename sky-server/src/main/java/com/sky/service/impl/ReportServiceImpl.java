...
public class ReportServiceImpl implements ReportService {
    ...
    public TurnoverReportVO getTurnoverStatistics(LocalDate begin, LocalDate end) {
        ...
        for(LocalDate date : dateList) {
            log.info("Query turnover statistics for date: {}", date);
    ...
    public UserReportVO getUserStatistics(LocalDate begin, LocalDate end) {
        ...
        for(LocalDate date : dateList) {
            log.info("Query new user statistics for date: {}", date);
            LocalDateTime beginTime = LocalDateTime.of(date, LocalTime.MIN);
            LocalDateTime endTime = LocalDateTime.of(date, LocalTime.MAX);
            Map map = new HashMap();
            map.put("end", endTime);
    ...
    public OrderReportVO getOrderStatistics(LocalDate begin, LocalDate end) {
        ...
        for(LocalDate date : dateList) {
            log.info("Query order statistics for date: {}", date);
            LocalDateTime beginTime = LocalDateTime.of(date, LocalTime.MIN);
            LocalDateTime endTime = LocalDateTime.of(date, LocalTime.MAX);
    ...
    public void exportReport(HttpServletResponse response) {
        ...
        try {
            //Based on the template file, create a new Excel file
            ...
            //Download the Excel file to the client browser through the output stream
